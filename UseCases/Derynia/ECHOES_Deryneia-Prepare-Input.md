...
We started with the [xmind representation of Deryneia] (Painted Artwork (and actors involved).xmind) provided by S. Hermon, CyI.
Available also as [pdf file] (Painted Artwork (and actors involved).pdf)) 
...
The export of SYNTHESIS is an xml representation. The files are available in [XML input files](xml-input/).
